 ...
 */
/*
Bloque Amarillo es un bloque el cual se rompe al tocarlo cuatro veces
 */
public class Amarillo extends Bloque {
    public Amarillo(Point punto, int ancho, int alto, int vX, int vY) {
        super(4, Color.YELLOW, punto, ancho, alto, vX, vY);
    }
}
